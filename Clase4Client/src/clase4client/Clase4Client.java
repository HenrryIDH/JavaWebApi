...
public static void main(String[] args) throws Exception{
        //Cliente HTTP
        System.out.println("Testing Cliente");
        String url = "";
        //url = "http://localhost:8083/Clase4/ArticuloAlta?id=4&descripcion=Teclado2&precio=5000";
       ...
       // System.out.println(getBody("https://ws.smn.gob.ar/map_items/weather"));
        ...
        //System.out.println(getBody("http://localhost:8083/Clase5/ArticuloAlta?id=16&descripcion=MonitorHD&precio=15000"));
        System.out.println("****************************************************");
